...
# Function accepts nothing and returns nothing
def Demo1():
    print("Inside Demo1")
...
# Function accepts one argument and returns one parameter
def Demo3(No):
    print("Inside Demo3 with argument",No)
    return No+2

# Function accepts two argument and returns one parameter
def Demo4(No1,No2):
    print("Inside Demo4")
    Add = No1 + No2
    return Add

# Function accepts one argument and returns two parameter
def Demo5(No1,No2):
    print("Inside Demo5")
    Add = No1 + No2
    Sub = No1 - No2
